.. meta::
   :description: Familiarize yourself with contributing to the Paas Charm charm documentation.
...
Our documentation is hosted on `Read the Docs <TODO_DOCS_HOSTING_URL>`_ to enable collaboration.
...
`source code on GitHub <https://github.com/canonical/paas-charm>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/paas-charm/issues>`_

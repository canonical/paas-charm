...
25. `rotate_secret_key <https://canonical-juju.readthedocs-hosted.com/en/latest/user/reference/hook/#secret-rotate>`_: fired when rotate-secret-key is executed.  **Action**: generate a new secret token for the application.

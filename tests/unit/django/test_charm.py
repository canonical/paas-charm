...
TEST_DJANGO_CONFIG_PARAMS = [
    pytest.param(
        {},
        {
            ...
            'DJANGO_OIDC_SCOPES': 'openid profile email',"DJANGO_SECRET_KEY": "test", "DJANGO_ALLOWED_HOSTS": '["django-k8s.none"]'},
        id="default",
    ),
    pytest.param(
        ...
        {
            'DJANGO_OIDC_REDIRECT_PATH': '/callback',
            'DJANGO_OIDC_SCOPES': 'openid profile email',"DJANGO_SECRET_KEY": "test", "DJANGO_ALLOWED_HOSTS": '["test.local", "django-k8s.none"]'},
        id="allowed-hosts",
    ),
    pytest.param(
        {"django-debug": True},

    ...
    [
        pytest.param(
            {},
            {
                ...
                "METRICS_PORT": "8080",
                "OIDC_REDIRECT_PATH": "/login/oauth2/code/oidc",
                "OIDC_SCOPES": "openid profile email",
                "OIDC_USER_NAME_ATTRIBUTE": "sub",
                "METRICS_PATH": "/actuator/prometheus",
                "management.endpoints.web.exposure.include": "prometheus",
                "management.endpoints.web.base-path": "/actuator",
                "management.endpoints.web.path-mapping.prometheus": "prometheus",
                "BASE_URL": "http://spring-boot-k8s.test-model:8080",
                "SECRET_KEY": "test",
                "PEER_FQDNS": "spring-boot-k8s-0.spring-boot-k8s-endpoints.test-model.svc.cluster.local",
        ...
        pytest.param(
            ...
            {
                "SERVER_PORT": "9000",
                "BASE_URL": "http://spring-boot-k8s.test-model:9000",
                "METRICS_PORT": "9001",
                "OIDC_REDIRECT_PATH": "/login/oauth2/code/oidc",
                "OIDC_SCOPES": "openid profile email",
                "OIDC_USER_NAME_ATTRIBUTE": "sub",

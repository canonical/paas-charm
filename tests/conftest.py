...
def pytest_addoption(parser):
    ...
    parser.addoption("--test-tracing-flask-image", action="store")
    ...
    parser.addoption("--django-tracing-app-image", action="store")
    parser.addoption("--fastapi-app-image", action="store")
    parser.addoption("--fastapi-tracing-app-image", action="store")
    parser.addoption("--go-app-image", action="store")
    parser.addoption("--go-tracing-app-image", action="store")
